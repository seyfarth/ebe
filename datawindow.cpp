    ...
    : QFrame(parent)
{
    ...
    dataTree->setToolTip(tr("Left click on a > symbol to expand an item.\n"
    ...
    qRegisterMetaType < QList<VariableDefinition>
        > ("QList<VariableDefinition>");

    connect(gdb, SIGNAL(sendGlobals(QList<VariableDefinition>)), this,
        SLOT(receiveGlobals(QList<VariableDefinition>)));
    connect(gdb, SIGNAL(sendLocals(QList<VariableDefinition>)), this,
        SLOT(receiveLocals(QList<VariableDefinition>)));
    connect(gdb, SIGNAL(sendParameters(QList<VariableDefinition>)), this,
        SLOT(receiveParameters(QList<VariableDefinition>)));
    connect ( this,
        SIGNAL(requestVar(DataMap*,QString,QString,QString,QString,int,int,int)),
        gdb, SLOT(requestVar(DataMap*,QString,QString,QString,QString,int,int,int)) );
    ...
    : QTreeWidget(parent)
{
    ...
    ::parameters = parameters =
                   addDataItem(parameterMap, tr("parameters"), "", "");
    ::userDefined = userDefined =
                   addDataItem(userDefinedMap, tr("user-defined"), "", "");
...
DataItem *DataTree::addDataItem(DataMap *map, QString n, QString t, QString v)
{
