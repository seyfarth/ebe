...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Thu Nov 22 14:11:45 2012
# Project:  qtebe.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile qtebe.pro
#############################################################################
...
INCPATH       = -I/usr/lib64/qt4/mkspecs/linux-g++ -I. -I/usr/include/QtCore -I/usr/include/QtGui -I/usr/include/QtWebKit -I/usr/include -I. -I.
LINK          = g++
...
Makefile: qtebe.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qtebe1.0.0/ && $(COPY_FILE) --parents mainwindow.h sourcewindow.h commandline.h sourceedit.h registerwindow.h .tmp/qtebe1.0.0/ && $(COPY_FILE) --parents ebe.qrc .tmp/qtebe1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp sourcewindow.cpp commandline.cpp sourceedit.cpp registerwindow.cpp .tmp/qtebe1.0.0/ && (cd `dirname .tmp/qtebe1.0.0` && $(TAR) qtebe1.0.0.tar qtebe1.0.0 && $(COMPRESS) qtebe1.0.0.tar) && $(MOVE) `dirname .tmp/qtebe1.0.0`/qtebe1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qtebe1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_sourcewindow.cpp moc_commandline.cpp moc_sourceedit.cpp moc_registerwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_sourcewindow.cpp moc_commandline.cpp moc_sourceedit.cpp moc_registerwindow.cpp
...
moc_sourcewindow.cpp: sourcewindow.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) sourcewindow.h -o moc_sourcewindow.cpp

moc_commandline.cpp: sourcewindow.h \
		commandline.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) commandline.h -o moc_commandline.cpp

moc_sourceedit.cpp: sourceedit.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) sourceedit.h -o moc_sourceedit.cpp

moc_registerwindow.cpp: registerwindow.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) registerwindow.h -o moc_registerwindow.cpp
...
qrc_ebe.cpp: ebe.qrc \
		...
		html/running.html \
		images/ebe64.png
	/usr/lib64/qt4/bin/rcc -name ebe ebe.qrc -o qrc_ebe.cpp
