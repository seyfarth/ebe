...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Sun Nov 18 14:39:01 2012
# Project:  qtebe.pro
# Template: app
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		sourcewindow.cpp moc_mainwindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qtebe1.0.0/ && $(COPY_FILE) --parents mainwindow.h sourcewindow.h .tmp/qtebe1.0.0/ && $(COPY_FILE) --parents ebe.qrc .tmp/qtebe1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp sourcewindow.cpp .tmp/qtebe1.0.0/ && (cd `dirname .tmp/qtebe1.0.0` && $(TAR) qtebe1.0.0.tar qtebe1.0.0 && $(COMPRESS) qtebe1.0.0.tar) && $(MOVE) `dirname .tmp/qtebe1.0.0`/qtebe1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qtebe1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_sourcewindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_sourcewindow.cpp
