...
static const char qt_meta_stringdata_ConsoleWindow[] = {
    "ConsoleWindow\0"
};
...
const QMetaObjectExtraData ConsoleWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ConsoleWindow::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ConsoleWindow,
      qt_meta_data_ConsoleWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ConsoleWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ConsoleWindow))
